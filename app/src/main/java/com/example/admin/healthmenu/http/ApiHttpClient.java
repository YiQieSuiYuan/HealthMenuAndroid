package com.example.admin.healthmenu.http;
...
public class ApiHttpClient {
    ...
    private static String API_URL = "http://baike.baidu.com/%s";
    private static String API_URL_LOCAL = "http://192.168.52.2:8080/%s";
